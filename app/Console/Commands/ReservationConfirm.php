...
class ReservationConfirm extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ReservationConfirm:confirm';
     ...
     * @var string
     */
    protected $description = 'notify reservation confirmation successfully';
