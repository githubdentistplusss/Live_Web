...
class SickController extends Controller
{
    ...
    public function activate(request $request, $id)
    {
        ...
        $Users->update();
        $request->session()->flash("message", "Patient Activated successfully");
    ...
    public function disable(request $request, $id)
    {
        ...
        $Users->update();
        $request->session()->flash("message", "Patient Disabled successfully");
    ...
    public function update(request $request, $id)
    {
        ...
        return redirect('/home/sicks/add/'.$id);
