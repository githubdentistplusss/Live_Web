...
*/
$_SESSION['clinic_id'] = $_SESSION['userInfo']['clinic_status'];



if ($log->isLogged)
{
    if (current_page() =='get_contract')
    {
    	include ('pages/content/get_contract.php');
    }
    else
    {
...
function current_page() 
{
	...
	if(isset($params [0]))
	{
		$user = array ('dashboard', 'booking','offers' ,'info','hours',
						'add_offer','edit_offer','confirm_booking','contract','get_contract') ; 
