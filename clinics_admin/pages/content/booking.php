...
$sql ="SELECT *,  offer_booking.created_at FROM offer_booking, offers, users, clinics
	...
	$bookings = $db->data_query ($sql);
...

		{
			...
			$bookings[$key]['offer_info'] = '

								<h2 class="table-avatar">

									<a href=""><b> '. $value['offer_title'].' </b><span>'.$value['clinic_name'].'</span></a>
