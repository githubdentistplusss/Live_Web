                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="file" class="form-control loginInput" name="photo">
                                             @if($aDentist->photo!="")
                                            <a href='{{asset('images/'.$aDentist->photo)}}' target='_blank'>
                                                <img class="img-thumbnail img-responsive" width="70" height="70"
                                                     src="{{asset('images/'.$aDentist->photo)}}" alt=""></a>
                                                    
                                                      <a style="color:red" href="{{url('home/dentists/photo/photo/id/'.$aDentist->id )}}">Delete</a>
                                                       @endif
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            @if($aDentist->profile_photo!="")
                                            <img class="img-thumbnail img-responsive" width="70" height="70"
                                                 src="{{asset('images/'.$aDentist->profile_photo)}}" alt="">
                                                 
                                                  <a style="color:red" href="{{url('home/dentists/photo/profile_photo/id/'.$aDentist->id )}}">Delete</a>
                                                    @endif
                                     ...
                                     <div class="form-group col-md-8">
                                            ...
                                            <textarea  id="note" type="text" class="form-control loginInput "
                                                   name="note">{{$aDentist->note}}</textarea>
