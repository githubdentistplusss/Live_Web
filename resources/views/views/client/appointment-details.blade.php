        ...
        <div class="card-body">
            ...
            <div class="content pt-4 pb-4">
                ...
                <div class="date-det pb-3">
                    ...
                    <input class="form-control loginInput" name="name" required type="text"
                        value="@if ($object[0]->status == '1' || $object[0]->status == '2' || $object[0]->status == '3' || $object[0]->status == '5') {{ $object[0]->D_name }} @endif" readonly>
                ...
                <div class="date-det pb-3">
                    ...
                    <input class="form-control loginInput" name="name" required type="text" value="@if ($object[0]->status == '1' || $object[0]->status == '2' || $object[0]->status == '5') {{ $object[0]->D_mobile }} @endif"
                    readonly>
                ...
                <div class="date-det pb-3">
                    ...
                    <input class="form-control loginInput" name="name" required type="text" value="@if ($object[0]->status == '1') @if ($follower)
                ...
                <div class="date-det pb-3">
                    ...
                    <input class="form-control loginInput" name="name" required type="text" value="@if (!empty($object[0]->description)) {{ $object[0]->description }} @endif"
                    readonly>
                </div>
                @if ($object[0]->status !== 3 && $object[0]->status !== 4)
                    ...
                    @if (isset(Auth::guard('dentist')->user()->id))
                        ...
                        <a href="{{ route('approveArrival', $object[0]->event_id) }}"
                            class="btn btn-sucess btn-md login-btn {{ $interval->days > 0 && $object[0]->start_time < $now_time ? 'isDisabled' : '' }}">@lang('resrv.confirm3')
                        </a>
                        <?php }
                    ...
                    @if (isset(Auth::guard('client')->user()->id))
                        ...
                        <div class="btns">
                            <a href="{{ route('accepetArr', $object[0]->event_id) }}"
                                class="navBtn {{ $interval->days > 1 ? 'isDisabled' : '' }}" 
                                
                                class="btn btn-success btn-md login-btn">@lang('resrv.confirm2')</a>
