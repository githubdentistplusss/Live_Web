        ...
        <div class="card-body pt-0">
            ...
            <nav class="user-tabs mb-4">
                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('bookedservices') }}"><span
            ...
            <div class="row">
									...
									<div style="background-color:#1c598F !important;height:30px">
									   ...
									   <div style="width:20%;color:white">#{{$service->serv_booking_id}}</div>
									   
									    @if($service->serv_booking_status==1)
									...
									<div style="padding:15px !important" class="pro-content">
											...
											<i style="color:#1c598F !important" class="fas fa-clinic-medical"></i> <span style="font-size:17px;color:black;font-wight:bold;">{{ isset($service->clinic_name) ? $service->clinic_name : '' }}
									
										
										<hr>
								
										<i style="color:#1c598F !important" class="fas fa-award"></i> <span style="font-size:14px;color:black;">{{ $service->private_serv_name }} 
											<br>
										...
										<i class="fa fa-money" aria-hidden="true"></i>
											<i style="color:#1c598F !important" class="fas fa-money-bill-alt"></i> <span style="font-size:14px;color:black;"> {{$service->serv_booking_price}} ريال
											<br>
										...
										<hr>
                                                      ...
                                                      <center>   <a href="{{ url('/serviceNeglect/' . $service->serv_booking_id) }}" class="btn btn-sm bg-danger-light">
