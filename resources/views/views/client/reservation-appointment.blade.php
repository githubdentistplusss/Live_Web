					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								...
								<!-- Add Blog -->
								<form method="POST" enctype="multipart/form-data" autocomplete="off" id="update_service" action="{{ route('createReservation')}}">
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input class="form-control" type="text" name="name_title"  value="{{$name}}"
												readonly="" required="">
										</div>
									</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="hidden" name="start"  value="{{$time_raw}}">
											<input class="form-control" type="text" name="date_title" 
												value="{{$date.' '.$time}}" readonly="" required="">
										</div>
									</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input class="form-control" type="text" name="service_title" id="service_title" value="{{$service}}"
												readonly="" required="">
										</div>
									</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="hidden" name="hospital"  value="{{$hospital_id}}">
												<input type="hidden" name="dentist"  value="{{$dentist_id}}">
											<input class="form-control" type="text" name="service_title" id="service_title"
												value="{{$hospital}}" readonly="" required="">
										</div>
									</div>
