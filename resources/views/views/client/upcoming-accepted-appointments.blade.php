        ...
        <div class="card-body pt-0">
            ...
            <nav class="user-tabs mb-4">
                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('UAReservation') }}">@lang('resrv.uADate')</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('prevReservation') }}">@lang('resrv.pDate')</a>
                    </li>
                </ul>
            </nav>
            <!-- /Tab Menu -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="doctor-profile" class="avatar avatar-sm mr-2">
                                                            ...
                                                            @if($event->status == 1 || $event->status == 2 || $event->status == 3 || $event->status == 5)
                                                            
                                                             <a href="#">{{$dentist[$i]->name}}<span></span></a>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($event->status == 5)
                                                        <span
                                                            class="badge badge-pill bg-success-light">@lang('resrv.satus5')</span>
