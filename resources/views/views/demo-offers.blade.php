...
<div id="myNav" style="width: 100%;
  ...
  <span class="input-group-text border-0" id="search-addon">
    ...
    text-align: center;overflow:auto" id="" type="button" data-filter="{{$cat->cat_id}}" data-type="{{$cat->cat_type}}" class="btn categ view-btn  btn-outline-primary filter-cat-offers maincategories carouselImage type{{$cat->cat_type}} ">{{$cat->cat_name}}</button>
											...
											<form   action="{{url('bookoffer')}}" method="post">
                                             ...
                                             @method('PUT')
                                              ...
                                              <div class="col-6">
													...
													<a href="{{ Route('offerdetails',$offer->offer_id) }}" class="btn book-btn" tabindex="0"> حجز الان </a>
