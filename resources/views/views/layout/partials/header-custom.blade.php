                  ...
                  @if (!isset(Auth::guard('client')->user()->id))
                    <li class="has-submenu {{ Route::is('clientLoginForm')  ? 'active' : '' }}"  >
							...
							<ul class="submenu">
								...
								<li class=""><a href="{{ Route('dentistLoginForm') }}">@lang('about.dentist')</a></li>
							</ul>
						</li>
						@else
						 <li class="has-submenu {{ Route::is('clientLoginForm')  ? 'active' : '' }}"  >
            ...
            <ul class="nav header-navbar-rht" class="col-sm">
                ...
                @else
                    ...
                    <li class="nav-item dropdown has-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-left">
                            <a class="{{ Route::is('dentistLoginForm') ? 'active dropdown-item' : 'dropdown-item' }}"
                                href="{{ Route('dentistLoginForm') }}">@lang('about.dentist')</a>
