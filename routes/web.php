...
|
*/
Route::get('/google4dbc83e85a87d759.html', function () {
    echo  File::get(url('public/google4dbc83e85a87d759.html'));
});
    App::setLocale('ar');
...
Route::get('/queue-restart', function () {
    ...
    return 'Application queue restart';
});
...
Auth::routes();
Route::get('/home', 'backstage\statisticsController@index')->name('home');


Route::get('/bookservice/{id}/{service}', 'ClinicController@bookservice')->name('bookservice');

Route::get('/bookedservices', 'ClinicController@bookedservices')->name('bookedservices');

Route::get('/serviceNeglect/{id}', 'ClinicController@serviceNeglect')->name('serviceNeglect');
...
Route::group(['middleware' => ['web']], function () {
    Route::get('/sendNotification', 'ApiEventController@showNotify')->name('sendNotify');
    Route::post('/notifyAction', 'ApiEventController@notifyUsers')->name('notifyAction');
});
//Hospital
Route::get('/home/hospitals', 'backstage\HospitalController@index')->name('showhospital');
Route::get('/home/search', 'backstage\HospitalController@search')->name('searchhospital');
...
Route::get('/demoffers', 'offerController@demoffers')->name('demoffers');

Route::get('/catoffers/{id}', 'offerController@catoffers')->name('catoffers');

Route::get('/sortoffers/{id}', 'offerController@sortoffers')->name('sortoffers');


Route::put('/bookoffer', 'offerController@bookoffer')->name('bookoffer');

Route::get('/offerdetails/{id}', 'offerController@offerdetails')->name('offerdetails');

Route::post('/offerdetails/{id}', 'offerController@offerdetails')->name('offerdetails');

Route::get('/bookedoffers', 'offerController@bookedoffers')->name('bookedoffers');

Route::get('/offerbookdetails/{id}', 'offerController@offerbookdetails')->name('offerbookdetails');


Route::get('/offerNeglect/{id}', 'offerController@offerNeglect')->name('offerNeglect');



Route::get('/search_offers', 'offerController@search_offers')->name('search_offers');
...
//statistics
Route::get('/home/statistics', 'backstage\statisticsController@index')->name('statistics');

Route::get('/home/table', 'backstage\tableController@index')->name('table');



//Dentists
Route::get('/home/dentists', 'backstage\DentistController@index')->name('showdentist');
Route::get('/home/dentists/photo/{photo}/id/{ids}', 'backstage\DentistController@deleteimg')->name('deleteimg');
...
Route::put('/home/dentists/activate/{id}', 'backstage\DentistController@activate')->name('activatedentist');
Route::put('/home/dentists/disable/{id}', 'backstage\DentistController@disable')->name('disabledentist');
...
Route::put('/home/sicks/activate/{id}', 'backstage\SickController@activate')->name('activatesick');
Route::put('/home/sicks/disable/{id}', 'backstage\SickController@disable')->name('disablesick');

//Orders
Route::get('/home/orders', 'backstage\OrderController@index')->name('showorder');
Route::get('/home/orders/search', 'backstage\OrderController@searchorder')->name('searchorder');
...
Route::get('/home/orders/edit/{id}', 'backstage\OrderController@editorder')->name('editorder');
Route::get('/home/orders/photo/{photo}/id/{ids}', 'backstage\OrderController@deleteimg')->name('deleteimg');
Route::put('/home/orders/update/{id}', 'backstage\OrderController@updateorder')->name('updateorder');
...
Route::get('/change-dentist-password', 'DentistController@changePassword')->name('changeDentistPassword');


// Clinic Routes


Route::get('clinic/confirm_booking', function(){
    return view('views.clinic/confirm_booking');
})->name('confirm_booking');


Route::get('/clinic-login', function(){
    return view('views.clinic-login');
})->name('clinicLogin');

Route::get('/clinic-member', function(){
    return view('views.clinic-member');
})->name('clinic-member');

Route::get('/clinic-page', function(){
   return view('views.clinic-page');
})->name('clinic-page');



Route::get('/clinic/{id}/{name}', 'ClinicController@index')->name('clinic');

Route::get('/allclinics', 'ClinicController@allclinics')->name('allclinics');

Route::get('/clinic-register', function(){
    return view('views.clinic-register');
})->name('clinicRegister');
...
// Client Dashboard
Route::get('/clientDashboard', 'offerController@bookedoffers')->name('clientDashboard');
...
Route::get('change-client-password', 'UserController@changePassword')->name('changeClientPassword');
//client Profile
...
Route::get('/search-appointment', 'EventController@reservationFormGet2')->name('searchAppointment');
Route::get('/search/start/{start}/hospital/{hospital}/service/{service}/date/{date}/dentist/{dentist}', 'EventController@search')->name('SearchTime');
Route::get('/NotValid', 'EventController@notValid')->name('notvalidReser');
Route::put('/addReservation', 'EventController@store')->name('createReservation');
Route::get('/details/{id}', 'EventController@details')->name('deatils');
  ...
  Route::put('/bookingdetails', 'EventController@bookingdetails')->name('bookingdetails');
...
// frontend pages
//contact us
  Route::get('/contact-us', 'ContactController@contact')->name('contactus');
...
//about us
    Route::get('/about', 'frontController@aboutUs')->name('aboutus');
     Route::get('/Privacy-Policy', 'frontController@Privacy')->name('PrivacyPolicy');
       ...
       Route::get('/termsdentist', 'frontController@termsdentist')->name('termsdentist');
    ...
    Route::get('dnotifications', 'NotificationController@NotificationByDentist')->name('NotificationByDentist');
    Route::get('cnotifications', 'NotificationController@NotificationByUser')->name('NotificationByUser');


    Route::post('/uploadCard', 'DentistController@uploadCard')->name('uploadCard');
