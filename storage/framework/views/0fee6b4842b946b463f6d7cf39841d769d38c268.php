          ...
          <div class="contentWrap">
            ...
            <div class="content2">
              <h3 class="blue"><?php echo app('translator')->getFromJson('home.contacNow'); ?></h3>
			   <form id="contactForm" action="<?php echo e(route('postcontact')); ?>?lang=en" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shahin/Sites/dentist-backend/resources/views/frontend/contact.blade.php ENDPATH**/ ?>