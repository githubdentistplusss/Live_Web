...
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <a href='<?php echo e(asset('public/images/'.$aDentist->photo)); ?>' target='_blank'>
                                                <img class="img-thumbnail img-responsive" width="70" height="70"
                                                     src="<?php echo e(asset('public/images/'.$aDentist->photo)); ?>" alt=""></a>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img class="img-thumbnail img-responsive" width="70" height="70"
                                                 src="<?php echo e(asset('public/images/'.$aDentist->profile_photo)); ?>" alt="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shahin/Sites/dentist-backend/resources/views/backstage/dentists/edit.blade.php ENDPATH**/ ?>