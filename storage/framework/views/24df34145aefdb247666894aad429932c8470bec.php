 ...
 <div class="form-group">
			...
			<a class="loginA" href="<?php echo e(route('terms')); ?>"> 	  <?php echo app('translator')->getFromJson('login.privacy'); ?> </a>
						...
						<div class="form-group row mb-0">
                            ...
                            <div class="col-md-5 offset-md-5 pr-5"><a class="loginA" href="<?php echo e(route('dentistlogin')); ?>">  <?php echo app('translator')->getFromJson('login.hasAccount'); ?></a></div>
                        </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsamat/public_html/demo/dentistplus/resources/views/vendor/register.blade.php ENDPATH**/ ?>