...
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <a href='<?php echo e(asset('images/'.$aDentist->photo)); ?>' target='_blank'>
                                                <img class="img-thumbnail img-responsive" width="70" height="70"
                                                     src="<?php echo e(asset('images/'.$aDentist->photo)); ?>" alt=""></a>
                                                      ...
                                                      <a style="color:red" href="<?php echo e(url('home/dentists/photo/photo/id/'.$aDentist->id )); ?>">Delete</a>
                                                       <?php endif; ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php if($aDentist->profile_photo!=""): ?>
                                            <img class="img-thumbnail img-responsive" width="70" height="70"
                                                 src="<?php echo e(asset('images/'.$aDentist->profile_photo)); ?>" alt="">
                                                 
                                                  <a style="color:red" href="<?php echo e(url('home/dentists/photo/profile_photo/id/'.$aDentist->id )); ?>">Delete</a>
                                                    <?php endif; ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                                       ...
                                       <div class="form-group col-md-8">
                                            <label for="note" class=" col-form-label text-md-right">ملاحظات</label>


                                            <input id="note" type="text" class="form-control loginInput "
                                                   name="note">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/backstage/dentists/edit.blade.php ENDPATH**/ ?>