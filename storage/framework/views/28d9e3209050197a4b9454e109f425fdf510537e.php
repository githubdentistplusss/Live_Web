        ...
        <div class="card-body pt-0">
            ...
            <nav class="user-tabs mb-4">
                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('dentistDashboard')); ?>"><?php echo app('translator')->getFromJson('resrv.dashboard'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('upcommingAcceptedReservation')); ?>"><?php echo app('translator')->getFromJson('resrv.uADate'); ?></a>
                    </li>
                   
                    <li class="nav-item">
                        <a class="nav-link active" href="#"><?php echo app('translator')->getFromJson('resrv.pDate'); ?></a>
                    </li>
                </ul>
            </nav>
            <!-- /Tab Menu -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif($event->status == 5): ?>
                                                        <span
                                                            class="badge badge-pill bg-danger-light"><?php echo app('translator')->getFromJson('resrv.satus5'); ?></span>

                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-right">
                                                    <div class="table-action row">
                                                        <a href=<?php echo e(url('/Ddetails/' . $event->id)); ?>
...
<?php echo $__env->make('views.dentist.dentist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/views/dentist/previous-appointments.blade.php ENDPATH**/ ?>