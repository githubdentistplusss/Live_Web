<?php $__env->startSection('content'); ?>
 ...
 <main class="main-content">
      ...
      <section class="upcomingDates">
        <div class="title">
          <div class="container">
            <h2><?php echo app('translator')->getFromJson('resrv.pDate'); ?></h2>
                    ...
                    <div class="row">
                      ...
                      <div class="col-9 col-md-10">
                        ...
                        <div class="row">
                          ...
                          <div class="col-6">
						  <br/>
                            <a href="<?php echo e(url('/Ddetails/'.$event->id)); ?>" class="w-btn"><?php echo app('translator')->getFromJson('login.details'); ?></a>
                          </div>
                        </div>
                      </div>
                    </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsamat/public_html/demo/dentistplus/resources/views/vendor/prevCalender.blade.php ENDPATH**/ ?>