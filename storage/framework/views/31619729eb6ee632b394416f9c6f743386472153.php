        ...
        <h4 class="blue2"><?php echo e($date); ?> /  <?php echo e($start_time); ?>    <?php echo e($am); ?></h4>
            ...
            <div class="accordion" id="accordion2">
              <div class="card">
                ...
                <div class="" id="teethCollapse" aria-labelledby="teethHeading" data-parent="#accordion">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-3 col-md-2 col-lg-1 preview"> </div>
                      <div class="col-9 col-md-10 col-lg-11 custom-upload">
                        <div class="custom-file">
                          <input class="custom-file-input teethImg" type="file" name="photo" id="customFile" required>
             ...
             <div class="content2">
              <div class="row">
                ...
                <div class="col-9 col-md-10 col-lg-11">
                  <h5 class="grey3">ملاحظات</h5></h5>
                  <input class="form-control loginInput medicine" name="notes" type="text" placeholder="ارغب بطبيب - ارغب بطبيبة">
                </div>
              </div>
            </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/event/reservationFormFinish.blade.php ENDPATH**/ ?>