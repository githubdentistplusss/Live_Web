  ...
  <span class="input-group-text border-0" id="search-addon">
    <i class="fas fa-search"></i>
    							...
    							<div class="card-body">
											...
											<div class="tab-content">
											  <div class="cat-offers-tab" id="cat-offers-tab">
											      ...
											      <div id="allcats" class="row " style="" >
											          
		<div style="width:100%" class="carouselContainer">
        <div  class="carouselOfImages">
          ...
          <button style="margin-left:20px;margin-bottom:20px;height:40px;font-size: 13px;
    text-align: center;overflow:auto" id="" type="button" data-filter="<?php echo e($cat->cat_id); ?>" data-type="<?php echo e($cat->cat_type); ?>" class="btn categ view-btn  btn-outline-primary filter-cat-offers maincategories carouselImage type<?php echo e($cat->cat_type); ?> "><?php echo e($cat->cat_name); ?></button>
...
<?php echo $__env->make('views.layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/views/demo-offers.blade.php ENDPATH**/ ?>