			   ...
			   <?php if($object[0]->status!="0"): ?>
				...
				<?php endif; ?>
				 ...
				 <?php if($object[0]->status=="1" || $object[0]->status=="2"): ?>
					<a href="<?php echo e(route('messages')); ?>">	  <img src="<?php echo e(asset('img/chat-bubbles.png')); ?>" width="35"></a>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsamat/public_html/demo/dentistplus/resources/views/client/details.blade.php ENDPATH**/ ?>