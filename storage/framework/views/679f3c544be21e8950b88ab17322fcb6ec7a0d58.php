        ...
        <div class="card-body">
            ...
            <div class="content pt-4 pb-4">
                ...
                <div class="date-det pb-3">
                    ...
                    <input class="form-control loginInput" name="name" required type="text"
                        value="<?php if($object[0]->status == '1' || $object[0]->status == '2' || $object[0]->status == '3' || $object[0]->status == '5' || $object[0]->status == '6' || $object[0]->status == '7'): ?> <?php echo e($object[0]->D_name); ?> <?php endif; ?>" readonly>
                ...
                <div class="date-det pb-3">
                    ...
                    <input class="form-control loginInput" name="name" required type="text" value="<?php if($object[0]->status == '1' || $object[0]->status == '2' || $object[0]->status == '5' || $object[0]->status == '6' || $object[0]->status == '7' ): ?> <?php echo e($object[0]->D_mobile); ?> <?php endif; ?>"
                    readonly>
                ...
                <div class="date-det pb-3">
                    ...
                    <input class="form-control loginInput" name="name" required type="text" value="<?php if($object[0]->status == '1' || $object[0]->status == '2' || $object[0]->status == '5' || $object[0]->status == '6' || $object[0]->status == '7' ): ?> <?php if($follower): ?>
                ...
                <div class="date-det pb-3">
                 ...
                 <div class="date-det pb-3">
                    ...
                    <input class="form-control loginInput" name="name" required type="text" value="<?php if(!empty($object[0]->drugs)): ?> <?php echo e($object[0]->description); ?> <?php endif; ?>"
                    readonly>
                </div>
                <?php if($object[0]->status !== 3 && $object[0]->status !== 4): ?>
                    ...
                    <?php if(isset(Auth::guard('dentist')->user()->id)): ?>
                        ...
                        <a href="<?php echo e(route('approveArrival', $object[0]->event_id)); ?>"
                            class="btn btn-primary btn-md login-btn <?php echo e($interval->days > 0 && $object[0]->start_time < $now_time ? 'isDisabled' : ''); ?>"><?php echo app('translator')->getFromJson('resrv.confirm3'); ?>
                        </a>
                        <?php }
                    ...
                    <?php if(isset(Auth::guard('client')->user()->id)): ?>
                        ...
                        <div class="btns">
                            <a href="<?php echo e(route('accepetArr', $object[0]->event_id)); ?>"
                                class="navBtn <?php echo e($interval->days > 1 ? 'isDisabled' : ''); ?>"><?php echo app('translator')->getFromJson('resrv.confirm2'); ?></a>
...
<?php echo $__env->make('views.dentist.dentist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/views/dentist/appointment-details.blade.php ENDPATH**/ ?>