        ...
        <nav class="navbar navbar-expand-lg navbar-light navbarRest"><a class="navbar-brand"
            ...
            <div class="collapse navbar-collapse" id="navbar">
              ...
              <li class="nav-item"><a href="#"><?php echo app('translator')->getFromJson('home.centers'); ?> </a></li>-->
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('contact')); ?>"> <?php echo app('translator')->getFromJson('home.contact'); ?></a></li>
                    <li class="nav-item">
...
<?php /**PATH /home/bsamat/public_html/demo/dentistplus/resources/views/frontend/app.blade.php ENDPATH**/ ?>