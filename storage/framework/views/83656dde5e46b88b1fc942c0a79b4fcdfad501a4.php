                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right p-4">
                                <div class="p-5">
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="<?php echo e(route('dForgetPasswordAction')); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('views.layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/views/dentist-forgot-password.blade.php ENDPATH**/ ?>