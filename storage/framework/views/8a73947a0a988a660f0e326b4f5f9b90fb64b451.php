...
<?php
 ...
 ?>
  <a href=" <?php echo e(url('/search/start/'.$time->start_time.'/end/'.$time->end_time.'/hospital/'.$hospital_id.'/service/'.$service_id.'/date/'.$date.'/dentist/'.$time->dentist_id)); ?>"><div class="time-available"> <span>  <?php echo e($time1); ?>  <?php echo e($am); ?></span></div> </a>   
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsamat/public_html/demo/dentistplus/resources/views/event/reservationFormRest.blade.php ENDPATH**/ ?>