        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-12 col-12">
                    ...
                    <h2 class="breadcrumb-title"><?php echo app('translator')->getFromJson('home.about'); ?></h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid p-4 card ">
            <div class="row">
                <div class="col-md-4 features-img">
                    <img src="<?php echo e(asset('assets/assets/img/about_dental.png')); ?>" class="img-fluid" alt="About us">
                </div>
                <div class="col-md-8">
                    <p class="p-3"><?php if( app()->getLocale()=='ar'): ?>
...
<?php echo $__env->make('views.layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/views/about.blade.php ENDPATH**/ ?>