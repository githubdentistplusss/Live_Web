        ...
        <div class="card-body pt-0">
            ...
            <nav class="user-tabs mb-4">
                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('UAReservation')); ?>"><?php echo app('translator')->getFromJson('resrv.uADate'); ?></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('prevReservation')); ?>"><?php echo app('translator')->getFromJson('resrv.pDate'); ?></a>
                    </li>
                </ul>
            </nav>
            <!-- /Tab Menu -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        ...
                                                        <a href="#"><?php echo e(isset($dentist[$i]->name) ? $dentist[$i]->name : ''); ?>
                                                ...
                                                <td>
                                                    <?php if($event->status == 0): ?>
                                                        <span
                                                            class="badge badge-pill bg-warning-light"><?php echo app('translator')->getFromJson('resrv.satus1'); ?></span>
                                                    ...
                                                    <?php elseif($event->status == 4): ?>
                                                        <span
                                                            class="badge badge-pill bg-danger-light"><?php echo app('translator')->getFromJson('resrv.satus7'); ?></span>

                                                    <?php elseif($event->status == 5): ?>
                                                        <span
                                                            class="badge badge-pill bg-danger-light"><?php echo app('translator')->getFromJson('resrv.satus6'); ?></span>
...
<?php echo $__env->make('views.client.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/views/client/previous-appointments.blade.php ENDPATH**/ ?>