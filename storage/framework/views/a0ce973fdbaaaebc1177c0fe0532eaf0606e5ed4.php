...
<form action="<?php echo e(route('sickSerach')); ?>" method="get" class="card-content collapse show" role="form"
    ...
    <div class="form-group">
        ...
        <a href="<?php echo e(route('showsick')); ?>" class="btn btn-secondary box-shadow-1 btn-min-width">All</a>
                                            ...
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $object): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($object->admin == 2): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if(isset($object->city['city_name_ar'])): ?>
                                                 

                                                      <td><?php echo e($object->city['city_name_ar']); ?></td>
                                                      ...
                                                      <td >
                                                        ...
                                                        <form action="<?php echo e(route('disablesick', $object->id)); ?>" method="post">
                              ...
                              <td> <form action="<?php echo e(route('activatesick', $object->id)); ?>" method="post">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/backstage/sicks/index.blade.php ENDPATH**/ ?>