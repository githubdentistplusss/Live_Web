        ...
        <div class="card-body pt-0">
            ...
            <nav class="user-tabs mb-4">
                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#"><?php echo app('translator')->getFromJson('resrv.uADate'); ?></a>
                    </li>
...
<?php echo $__env->make('views.dentist.dentist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/views/dentist/upcoming-accepted-appointments.blade.php ENDPATH**/ ?>