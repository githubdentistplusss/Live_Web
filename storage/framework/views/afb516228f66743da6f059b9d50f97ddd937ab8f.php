    ...
    <div class="container-fluid">
        <div class="banner-wrapper">
            <div class="banner-header text-center">
                <h1><?php echo app('translator')->getFromJson('home.search_appnt_now'); ?></h1>
                <p><?php echo app('translator')->getFromJson('home.discover_services'); ?></p>
            </div>

            <!-- Search -->
            <div class="search-box" >
                <form method="GET" action="<?php echo e(Route('searchAppointment')); ?>" enctype="multipart/form-data">
                    <div class="form-group search-service" class="col-sm-12">
                        ...
                        <select class="form-control" required name="service_id" id="service_id">
                            <option class="locate" selected disabled data-image="<?php echo e(asset('assets/imgs/home/location.svg')); ?>"><?php echo app('translator')->getFromJson('home.service'); ?>
                            </option>
                        ...
                        <span class="form-text"><?php echo app('translator')->getFromJson('home.services_check_up'); ?></span>
                    </div>
                    <div class="form-group search-location">
                       
                        <select class="form-control" required name="city" id="city_id">
                            <option class="locate" selected disabled data-image="<?php echo e(asset('assets/imgs/home/location.svg')); ?>"><?php echo app('translator')->getFromJson('home.city'); ?>
                            </option>
                            </select>
                        <span class="form-text"><?php echo app('translator')->getFromJson('home.based_location'); ?></span>
                    </div>
                    ...
                    <div class="form-group search-doctor">
                        ...
                        <select class="form-control" required name="hospital_id" id="hospital_id">
                            <option class="locate" selected disabled data-image="<?php echo e(asset('assets/imgs/home/location.svg')); ?>"><?php echo app('translator')->getFromJson('home.hospital'); ?>
                            </option>
                            
                        </select>
                        <span class="form-text"><?php echo app('translator')->getFromJson('home.based_location_hos'); ?></span>
                    </div>
                    
                    <button type="submit" class="btn btn-primary search-btn"><i class="fas fa-search"> </i>
                        <span><?php echo app('translator')->getFromJson('home.search'); ?></span></button>
                </form>
            </div>
            <!-- /Search -->
...
<!-- /Home Banner -->
			...
			<section class="section section-doctor">
			    ...
			    <h2><?php echo app('translator')->getFromJson('home.offer_trend'); ?></h2>
			    </div>
        ...
        <div class="carouselOfImages">
                 ...
                 <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<div style="" class="profile-widget carouselImage">
    									<div class="doc-img">
    										<a href="offerdetails/<?php echo e($offer->offer_id); ?>">
    										    
    											<img style="width:250px !important;height:150px !important" class="img-fluid" alt="<?php echo e($offer->offer_title); ?>" src="images/<?php echo e($offer->offer_photo); ?>">
    										</a>
						...
						<div class="col-lg-12" class="col-sm-12">
							...
							<a href="offers" class="btn book-btn1 mb-4" class="text-center"> <?php echo app('translator')->getFromJson('home.view_all_offers'); ?> </a>
							</div>
						</div>
                ...
                <div class="offer-slider slider">
                    ...
                    <div class="offer-widget">
                        <div class="card text-center doctor-book-card">
                            <img height="250" width="500" src="images/<?php echo e($offer->offer_photo); ?>" alt="" class="img-fluid">

                        </div>
                        <div class="pro-content">
                            <h3 class="title">
                                <a href="offerdetails/<?php echo e($offer->offer_id); ?>"><?php echo e($offer->clinic_name); ?></a>
                               <i style="display:none" class="fas fa-check-circle verified"></i>
                            </h3>
                            <p class="speciality"><?php echo e($offer->offer_sub_title); ?></p>
                            ...
                            <ul class="available-info">
                                ...
                                <li>
                                    <i class="far fa-money-bill-alt"></i> <?php echo e($offer->offer_new_price); ?>
...
<section style="padding-bottom:130px" class="section section-features">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="section-header text-center">
                    <h2 class="mt-2"><?php echo app('translator')->getFromJson('home.ios_android'); ?></h2>
                    <!--
  ...
  if (willDelete) {
    ...
    $('#city_id').on('change', function(event) {
          var service_id = document.getElementById('service_id').value ;
            ...
            var token = $('meta[name=csrf-token]').attr('content');
            $.ajax({
                url: "<?php echo e(Route('select-hospital')); ?>",
                method: 'POST',
...
<?php echo $__env->make('views.layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/views/index.blade.php ENDPATH**/ ?>