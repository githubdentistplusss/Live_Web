                    ...
                    <div class="notification">
                      <div class="row">
                        ...
                        <div class="h5 grey3"><i class="far fa-clock"></i> <?php echo e(\Carbon\Carbon::parse($notify->created_at)->diffForHumans()); ?></div>
                         ...
                         <a href="<?php echo e(url('/details/'.$notify->event_id)); ?>">
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/frontend/client/notifications.blade.php ENDPATH**/ ?>