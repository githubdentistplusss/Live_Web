...
.then((willDelete) => {
  ...
  <a href=""> <i class="fas fa-map-marker-alt"></i>
                        ...
                        <div class="col-md-4 col-lg-4">
                            ...
                            <div class="copyright-menu">
                                <ul style="text-align:center" class="policy-menu">
                                    <li><a href="<?php echo e(Route('terms')); ?>">الشروط والأحكام</a></li>
                                    <li><a href="<?php echo e(Route('PrivacyPolicy')); ?>">السياسه والخصوصيه</a></li>
                                </ul>
                            </div>
                            <!-- /Copyright Menu -->
    ...
    <!-- /Footer -->
<?php /**PATH /home/dentist/public_html/resources/views/views/layout/partials/footer.blade.php ENDPATH**/ ?>