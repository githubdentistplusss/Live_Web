                ...
                <div class="card-header" id="headingTwo">
                  <div class="row">
                    ...
                    <div class="col-9 col-md-10 col-lg-11">
                      ...
                      <h4 class="blue2">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"><?php echo e($followers); ?></button>
                      </h4>
                    </div>
                  </div>
                </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsamat/public_html/demo/dentistplus/resources/views/frontend/client/account.blade.php ENDPATH**/ ?>