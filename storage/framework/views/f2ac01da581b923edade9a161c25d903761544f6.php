...
<meta calss='ogimage' property="og:image" content="<?php echo e(url('/').'/uploads/'.Auth::guard('dentist')->user()->card); ?>">
...
<meta calss='ogimage' name="twitter:card" content="<?php echo e(url('/').'/uploads/'.Auth::guard('dentist')->user()->card); ?>">
        ...
        <div class="title">
          <div class="container">
            <h2><?php echo app('translator')->getFromJson('login.account'); ?></h2>
               ...
               <?php if(Auth::guard('dentist')->user()->active=="0"): ?>
               <div class="alert alert-danger col-md-12">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <strong style="color:Black;"><?php echo app('translator')->getFromJson('login.disabled'); ?></strong>
                </div>
               <?php endif; ?>
        ...
        $.ajax({
            ...
            success: function(data){
              if(data.status == 'success'){
               document.getElementById("doc_card").src = "uploads/"+data.card;
               document.getElementById("doc_card").alt = "<?php echo e(Auth::guard('dentist')->user()->name); ?>";
               $('meta[calss="ogimage"]').attr('content',"<?php echo e(url('/')); ?>/uploads/"+data.card);
              }
            },
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dentist/public_html/resources/views/vendor/account.blade.php ENDPATH**/ ?>